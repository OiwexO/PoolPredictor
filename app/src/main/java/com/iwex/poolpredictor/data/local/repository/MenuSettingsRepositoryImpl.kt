...
class MenuSettingsRepositoryImpl(private val preferences: SharedPreferences) : MenuSettingsRepository {

    override fun getAimSettings(): AimSettings = with(preferences) {
        return AimSettings(
            drawLinesEnabled = getBoolean(KEY_DRAW_LINES_ENABLED, AimSettings.DEFAULT.drawLinesEnabled),
            drawShotStateEnabled = getBoolean(KEY_DRAW_SHOT_STATE_ENABLED, AimSettings.DEFAULT.drawShotStateEnabled),
            drawOpponentsLinesEnabled = getBoolean(KEY_DRAW_OPPONENTS_LINES_ENABLED, AimSettings.DEFAULT.drawOpponentsLinesEnabled),
            preciseTrajectoriesEnabled = getBoolean(KEY_PRECISE_TRAJECTORIES_ENABLED, AimSettings.DEFAULT.preciseTrajectoriesEnabled),
    ...
    override fun getEspSettings(): EspSettings = with(preferences) {
        return EspSettings(
            ...
            trajectoryOpacity = getInt(KEY_TRAJECTORY_OPACITY, EspSettings.DEFAULT.trajectoryOpacity),
            shotStateCircleWidth = getInt(KEY_SHOT_STATE_CIRCLE_WIDTH, EspSettings.DEFAULT.shotStateCircleWidth),
            shotStateCircleRadius = getInt(KEY_SHOT_STATE_CIRCLE_RADIUS, EspSettings.DEFAULT.shotStateCircleRadius),
            shotStateCircleOpacity = getInt(KEY_SHOT_STATE_CIRCLE_OPACITY, EspSettings.DEFAULT.shotStateCircleOpacity)
        )
    }
